package hr.fer.zemris.fuzzy.task2.equivalence;
...
import hr.fer.zemris.fuzzy.task2.properties.Relations;
...
public class Primjer3 {
	public static void main(String[] args) {
		...
		IFuzzySet r = new MutableFuzzySet(Domain.combine(u, u))
			...
			.set(DomainElement.of(2,1), 0.3).set(DomainElement.of(2,3), 0.5)
