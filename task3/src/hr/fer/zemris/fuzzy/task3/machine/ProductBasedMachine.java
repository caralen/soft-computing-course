...
public class ProductBasedMachine implements DecisionMachine {
	
	private static final IBinaryFunction tNorm = Operations.algebraicProduct();
	private static final IBinaryFunction sNorm = Operations.zadehOr();
